...
const tokenKey = scryptSync(env.WHOOP_TOKEN_ENCRYPTION_KEY, SALT, KEY_LENGTH);
...
export const whoopTokenCrypto: TokenCrypto = {
  encrypt,
  decrypt
};

export { encrypt as encryptWhoopToken, decrypt as decryptWhoopToken };

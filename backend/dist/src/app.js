...
const router_5 = require("./modules/biomarkers/router");
const router_6 = require("./modules/insights/router");
const router_7 = require("./modules/community/router");
const router_8 = require("./modules/rooms/router");
const router_9 = require("./modules/admin/router");
const router_10 = require("./modules/notifications/router");
const router_11 = require("./modules/ai/router");
...
app.use('/biomarkers', router_5.biomarkerRouter);
app.use('/biomarker-logs', router_5.biomarkerLogRouter);
app.use('/admin', router_9.adminRouter);
app.use('/insights', router_6.insightsRouter);
app.use('/community', router_7.communityRouter);
app.use('/rooms', router_8.roomsRouter);
app.use('/notifications', router_10.notificationsRouter);
app.use('/ai', router_11.aiRouter);

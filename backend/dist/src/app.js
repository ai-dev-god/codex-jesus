...
const router_5 = require("./modules/gym/router");
const router_6 = require("./modules/biomarkers/router");
const router_7 = require("./modules/insights/router");
const router_8 = require("./modules/community/router");
const router_9 = require("./modules/rooms/router");
const router_10 = require("./modules/admin/router");
const router_11 = require("./modules/notifications/router");
const router_12 = require("./modules/ai/router");
...
app.use('/gym', router_5.gymRouter);
app.use('/dashboard', router_3.dashboardRouter);
app.use('/biomarkers', router_6.biomarkerRouter);
app.use('/biomarker-logs', router_6.biomarkerLogRouter);
app.use('/admin', router_10.adminRouter);
app.use('/insights', router_7.insightsRouter);
app.use('/community', router_8.communityRouter);
app.use('/rooms', router_9.roomsRouter);
app.use('/notifications', router_11.notificationsRouter);
app.use('/ai', router_12.aiRouter);

...
vpath_build = no
abs_top_builddir = /usr/src/postgresql
abs_top_srcdir = /usr/src/postgresql
...
python_libdir		= /usr/lib/python3.6/config-3.6m-x86_64-linux-gnu
python_libspec		= -L/usr/lib/python3.6/config-3.6m-x86_64-linux-gnu -lpython3.6m
...
SUN_STUDIO_CC = no
CXX = g++
CFLAGS = -Wall -Wmissing-prototypes -Wpointer-arith -Wdeclaration-after-statement -Werror=vla -Wendif-labels -Wmissing-format-attribute -Wimplicit-fallthrough=3 -Wshadow=compatible-local -Wformat-security -fno-strict-aliasing -fwrapv -fexcess-precision=standard -Wno-format-truncation -Os -DMAP_HUGETLB=0x40000
CFLAGS_SL = -fPIC
...
CXXFLAGS = -Wall -Wpointer-arith -Wendif-labels -Wmissing-format-attribute -Wimplicit-fallthrough=3 -Wshadow=compatible-local -Wformat-security -fno-strict-aliasing -fwrapv -O2
...
AR = ar
AROPT = crs
LIBS = -lxslt -lxml2 -lssl -lcrypto -lz -lpthread -lrt -ldl -lm 
LDAP_LIBS_FE = 
LDAP_LIBS_BE = 
...
PERL		= '/usr/bin/perl'
perl_archlibexp		= /usr/lib/x86_64-linux-gnu/perl/5.26
perl_privlibexp		= /usr/share/perl/5.26
perl_includespec	= -I/usr/lib/x86_64-linux-gnu/perl/5.26/CORE
perl_embed_ccflags	= -DDEBIAN 
perl_embed_ldflags	=   -L/usr/lib/x86_64-linux-gnu/perl/5.26/CORE -lperl -ldl -lm -lpthread -lc -lcrypt

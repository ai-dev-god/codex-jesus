...
- Execute Playwright via the documented entry point (e.g. `npm run test:e2e --prefix bh-fe`). Capture HTML reports, traces, and screenshots under `test-results/e2e/`.
